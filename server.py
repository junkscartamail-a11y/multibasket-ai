...
async def analyze(image: UploadFile = File(...)):
    ...
    r=client.responses.create(model=os.getenv("OPENAI_MODEL","gpt-4.1-mini"),input=[
        ...
        {"role":"user","content":[{"type":"input_text","text":"Estrai i dati dallo screenshot."},{"type":"input_image","image_url":f"data:{mime};base64,{b64}"}]}
    ])
    return {"extracted": parse_json(r.output_text)}
